...
TRANSACTION_BITS.update({
    ...
    60: ['Pemda', 'Kode Pemda', 'LLL', 3+996, 'ans'],
    # 1-18 NOP, 19-22 Tahun Pajak
    ...
    # 1-4 Kode Cabang, 5-8 User ID
    107: ['Cabang', 'Kode Cabang, User ID', 'LLL', 3+996, 'ans'],
    })
...
ERR_CREATE_NTP = 'Max loop for create payment ID. Call your programmer '\
                 'please.'
