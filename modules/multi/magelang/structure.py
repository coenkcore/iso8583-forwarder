from common.bphtb.structure import TRANSACTION_BITS as BASE_TRANSACTION_BITS 


TRANSACTION_BITS = BASE_TRANSACTION_BITS.copy()
TRANSACTION_BITS.update({
    41: ['Terminal ID', 'Primary Account Number', 'ANS', 10, 'ans'],
    48: ['Invoice ID', 'Invoice Profile', 'LLL', 999, 'ans'],
...
ERR_INVALID_LENGTH = 'Invoice ID {id} harus 12 / 14 karakter (PADL / BPHTB)'
